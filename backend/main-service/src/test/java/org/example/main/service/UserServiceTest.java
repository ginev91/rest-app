 ...
 *
 * This file merges the original tests and the additional ones, and avoids unnecessary stubbings
 * by only stubbing behavior that each test actually needs.
 */
...
class UserServiceTest {
    ...
    void me_userdetails_and_session_and_tableResolution() {
        ...
        // use a dedicated mock for UserDetails to keep stubbing tight to this test
        ...
        // use doReturn to avoid generic-method resolution issues with thenReturn
        ...
        // session attribute is string "2" to test parsing path
    ...
    @Test
    void me_sessionTableNumber_asNumber_isUsed_directly() {
